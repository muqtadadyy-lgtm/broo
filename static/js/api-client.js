...
// ==================== ENHANCED CHAT ROOM API ====================

async function apiUpdateChatRoomSettings(roomId, settings) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/settings`, {
            method: 'PUT',
...
async function apiGetChatRoomStats(roomId) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/stats`, {
            method: 'GET'
        });
        return response;
    } catch (error) {
...
async function apiArchiveChatRoom(roomId) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/archive`, {
            method: 'POST'
        });
        return response;
    } catch (error) {
...
async function apiDeleteChatRoom(roomId) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/delete`, {
            method: 'DELETE'
        });
        return response;
    } catch (error) {
...
async function apiGetChatRoomMembers(roomId) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/members`, {
            method: 'GET'
        });
        return response;
    } catch (error) {
...
async function apiManageChatRoomMember(roomId, targetUserId, action) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/members/manage`, {
            method: 'POST',
            body: JSON.stringify({
...
async function apiSearchChatMessages(roomId, query) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/search?q=${encodeURIComponent(query)}`, {
            method: 'GET'
        });
        return response;
    } catch (error) {
...
async function apiDeleteChatMessage(roomId, messageId) {
    try {
        const response = await apiRequest(`/chat-rooms/${roomId}/messages/${messageId}/delete`, {
            method: 'DELETE'
        });
        return response;
    } catch (error) {
